...
const PagContenedores = () => {
    ...
    return (
        <div className="pb-23 lg:pb-0">
            <h1 className="mt-14 md:mt-0 ml-5 md:ml-0 text-3xl font-bold text-[#2A5677] md:absolute md:top-20">
                Listado de Contenedores
            </h1>

            <div className="flex items-center mt-4 md:mt-0 gap-1">
                <div
                    className={`w-full ${!contenedorSeleccionado ? "w-[94%]" : "w-[50%]"} md:pt-8 flex justify-between`}
                >
            ...
            <div className={`w-full ${contenedorSeleccionado ? "lg:w-[53%]" : "w-full"}`}>
                {contenedores.length > 0 
                    ...
                    ) : (<p className="flex justify-center mt-10 mb-10 mr-17">No hay contenedores para mostrar</p>
                )}
