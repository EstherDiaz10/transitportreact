 ...
 const MenuItems = () => {
    ...
    switch (rol) {
      ...
      case 'administrativo':
        return (
          <>
            <NavLink to="/ordenes" className={({activo}) => `${styles} ${activo ? {activeStyles} : ''}`}>
            ...
            <NavLink to="/gruas" className={({activo}) => `${styles} ${activo ? {activeStyles} : ''}`}>
            ...
            <NavLink to="/contenedores" className={({activo}) => `${styles} ${activo ? {activeStyles} : ''}`}>
            ...
            <NavLink to="/buques" className={({activo}) => `${styles} ${activo ? {activeStyles} : ''}`}>
