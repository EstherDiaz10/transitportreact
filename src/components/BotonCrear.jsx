const BotonCrear = ({tipo, setCrearElemento, seleccionado}) => {
    ...
    const botonBase = `bg-[#5F84A2] text-white font-bold rounded-[5px] flex items-center justify-around text-lg hover:bg-[#DFECF5] hover:text-[#5F84A2] hover:border-3 hover:border-[#5F84A2] cursor-pointer h-10 mt-6 px-4 gap-4`;
    
    return (
        <div className="flex justify-center flex-wrap lg:w-[95%]">
