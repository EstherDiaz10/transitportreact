...
const DetallesGrua = ({ grua, setGruaSeleccionada, setGruas }) => {
    ...
    return (
        <div className="text-[#2A5677] relative pb-23 p-8 md:p-0">
            ...
            <button onClick={() => setGruaSeleccionada(null)} className="md:hidden absolute top-8 left-8 flex justify-center items-center text-white bg-[#5F84A2] text-xl font-bold hover:text-[#5F84A2] h-9 w-9 rounded-full hover:bg-white/20 cursor-pointer">
            ...
            <h1 className="text-center mt-1 lg:text-left  mb-8 text-xl md:text-3xl font-bold text-[#2A5677]">Detalles de la grúa</h1>
            <form action="">
                <div className="mt-5">
