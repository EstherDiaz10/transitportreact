...
const Detalles = ({ buque, setBuqueSeleccionado, setBuques }) => {
    ...
    return (
        <div className="text-[#2A5677] relative pb-23 p-8 md:pb-26 md:p-10 lg:p-0">
            ...
            <button onClick={() => setBuqueSeleccionado(null)} className="lg:hidden absolute top-8 left-8 md:top-11 flex justify-center items-center text-white bg-[#5F84A2] text-xl font-bold hover:text-[#5F84A2] h-9 w-9 rounded-full hover:bg-white/20 cursor-pointer">
            ...
            <h1 className="text-center mt-1 md:mt-3 lg:text-left mb-8 text-xl md:text-3xl font-bold text-[#2A5677]">Detalles del buque</h1>
            <form action="">
                <div className="mt-5">
                ...
                <div className="flex justify-center pt-5 lg:pt-2">
    <button 
        type="button" 
        onClick={handleEditar} 

        className="bg-[#5F84A2] text-white font-bold py-1 px-4 rounded-[5px] flex items-center justify-around text-lg hover:bg-[#DFECF5] hover:text-[#5F84A2] hover:border-3 hover:border-[#5F84A2] gap-3 leading-none"
    >
