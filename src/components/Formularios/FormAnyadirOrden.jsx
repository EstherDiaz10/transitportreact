...
const FormAnyadirOrden = ({ cerrarModal, setOrdenes }) => {
    ...
    const [contenedoresDisponibles, setContenedoresDisponibles] = useState([]);
      ...
      const validar = () => {
        ...
        if (!datosNuevaOrden.tipo) {
            nuevosErrores.tipo = "Selecciona el tipo de orden";
            esValido = false;
        }
        ...
        if (!datosNuevaOrden.grua_sts_id) {
            nuevosErrores.grua_sts_id = "Asigna una grúa STS";
            esValido = false;
        }
        if (!datosNuevaOrden.grua_sc_id) {
            nuevosErrores.grua_sc_id = "Asigna una grúa SC";
            esValido = false;
        }
        if (datosNuevaOrden.tipo === 'descarga' && !datosNuevaOrden.buque_id) {
            nuevosErrores.buque_id = "Selecciona el buque de origen";
            esValido = false;
        }
        if (datosNuevaOrden.tipo === 'carga' && !datosNuevaOrden.parking_id) {
            nuevosErrores.parking_id = "Selecciona el parking de origen";
            esValido = false;
        }
                ...
                <form onSubmit={crearOrden} className="text-[#2A5677]">
                    <div className={lineStyle}>
                        <div className={columnStyle}>
                            ...
                            {erroresOrden.tipo && <p className="text-red-600 text-sm">{erroresOrden.tipo}</p>}
                        </div>
                        <div className={columnStyle}>
                    ...
                    <div className={`${lineStyle} mt-6`}>
                        <div className={columnStyle}>
                            ...
                            {(erroresOrden.buque_id || erroresOrden.parking_id) && <p className="text-red-600 text-sm mt-1">{erroresOrden.buque_id || erroresOrden.parking_id}</p>}
                        </div>
                        <div className={columnStyle}>
                    ...
                    <div className="mt-6">
                        ...
                        {erroresOrden.contenedor_id && <p className="text-red-600 text-sm">{erroresOrden.contenedor_id}</p>}
                    </div>
                    ...
                    <div className={`${lineStyle} mt-6`}>
                        <div className={columnStyle}>
                            ...
                            {erroresOrden.grua_sts_id && <p className="text-red-600 text-sm">{erroresOrden.grua_sts_id}</p>}
                        </div>
                        <div className={columnStyle}>
                            <label>Grúa SC</label>
                            <div className="w-full mt-3">
                            ...
                            {erroresOrden.grua_sc_id && <p className="text-red-600 text-sm">{erroresOrden.grua_sc_id}</p>}
                        </div>
